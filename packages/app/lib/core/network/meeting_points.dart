...
class MeetingPoints extends Equatable {
  ...
  String? get previousHourToken => hourlyTokens.isNotEmpty ? hourlyTokens[0] : null;

  /// Get current hour's token.
  String? get currentHourToken => hourlyTokens.length > 1 ? hourlyTokens[1] : null;
...
class MeetingPointMatch extends Equatable {
  ...
  @override
  String toString() => 'MeetingPointMatch(peerId: $peerId, point: $meetingPoint, type: $type)';
}
